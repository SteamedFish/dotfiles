...
#
# Installation:
#   1. Copy this script to ~/.config/agents/hooks/
#   2. Make it executable: chmod +x ~/.config/agents/hooks/claudeception-activator.sh
#   3. Add to ~/.config/agents/settings.json (see README for details)
